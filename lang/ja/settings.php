...
$lang['dropdown']              = '翻訳を表示するためにドロップダウン一覧を使用する（５言語以上の場合推奨）。';
$lang['translateui']           = 'ユーザーインターフェイスの言語も、名前空間の外国語に切り替えるか？';
$lang['redirectstart']         = 'ブラウザーの言語を検出して、スタートページを言語の名前空間に自動的にリダイレクトするか？';
